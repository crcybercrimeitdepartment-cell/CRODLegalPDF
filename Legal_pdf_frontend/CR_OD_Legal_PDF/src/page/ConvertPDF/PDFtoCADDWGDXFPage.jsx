...
export default function PDFtoCADDWGDXFPage({ onBack }) {
  const toolName = "PDF to CAD DWG/DXF";
  const toolDesc = "Convert your PDF with PDF to CAD DWG/DXF.";
  const apiSlug = "pdf-to-cad";
  const outputExt = ".zip";
