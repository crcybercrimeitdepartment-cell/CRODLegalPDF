...
import WordToPDFPage from '../../page/ConvertToPDF/WordToPDFPage';
import ExcelToPDFPage from '../../page/ConvertToPDF/ExcelToPDFPage';
import PowerPointToPDFPage from '../../page/ConvertToPDF/PowerPointToPDFPage';
import JPGToPDFPage from '../../page/ConvertToPDF/JPGToPDFPage';
import PNGToPDFPage from '../../page/ConvertToPDF/PNGToPDFPage';
import ScreenshotToPDFPage from '../../page/ConvertToPDF/ScreenshotToPDFPage';
import TextToPDFPage from '../../page/ConvertToPDF/TextToPDFPage';
import HTMLToPDFPage from '../../page/ConvertToPDF/HTMLToPDFPage';
import GIFToPDFPage from '../../page/ConvertToPDF/GIFToPDFPage';
import BMPToPDFPage from '../../page/ConvertToPDF/BMPToPDFPage';
import TIFFToPDFPage from '../../page/ConvertToPDF/TIFFToPDFPage';
import WebPToPDFPage from '../../page/ConvertToPDF/WebPToPDFPage';
import SVGToPDFPage from '../../page/ConvertToPDF/SVGToPDFPage';
import HEICToPDFPage from '../../page/ConvertToPDF/HEICToPDFPage';
import RAWImageToPDFPage from '../../page/ConvertToPDF/RAWImageToPDFPage';
import RTFToPDFPage from '../../page/ConvertToPDF/RTFToPDFPage';
import MarkdownToPDFPage from '../../page/ConvertToPDF/MarkdownToPDFPage';
import XMLToPDFPage from '../../page/ConvertToPDF/XMLToPDFPage';
import CSVToPDFPage from '../../page/ConvertToPDF/CSVToPDFPage';
import JSONToPDFPage from '../../page/ConvertToPDF/JSONToPDFPage';
import EPUBToPDFPage from '../../page/ConvertToPDF/EPUBToPDFPage';
import MOBIToPDFPage from '../../page/ConvertToPDF/MOBIToPDFPage';
import ODTToPDFPage from '../../page/ConvertToPDF/ODTToPDFPage';
import ODSToPDFPage from '../../page/ConvertToPDF/ODSToPDFPage';
import ODPToPDFPage from '../../page/ConvertToPDF/ODPToPDFPage';
import VisioToPDFPage from '../../page/ConvertToPDF/VisioToPDFPage';
import PublisherToPDFPage from '../../page/ConvertToPDF/PublisherToPDFPage';
import XPSToPDFPage from '../../page/ConvertToPDF/XPSToPDFPage';
import CADToPDFPage from '../../page/ConvertToPDF/CADToPDFPage';
import PhotoshopToPDFPage from '../../page/ConvertToPDF/PhotoshopToPDFPage';
import IllustratorToPDFPage from '../../page/ConvertToPDF/IllustratorToPDFPage';
import EmailToPDFPage from '../../page/ConvertToPDF/EmailToPDFPage';
import OutlookToPDFPage from '../../page/ConvertToPDF/OutlookToPDFPage';
import WebPageToPDFPage from '../../page/ConvertToPDF/WebPageToPDFPage';
import ZIPToPDFPage from '../../page/ConvertToPDF/ZIPToPDFPage';
import FolderToPDFPage from '../../page/ConvertToPDF/FolderToPDFPage';
import MultipleFilesToPDFPage from '../../page/ConvertToPDF/MultipleFilesToPDFPage';
...
const TOOL_COMPONENTS = {
  ...
  'cad-to-pdf': CADToPDFPage,
  'photoshop-to-pdf': PhotoshopToPDFPage,
  'illustrator-to-pdf': IllustratorToPDFPage,
  'email-to-pdf': EmailToPDFPage,
  'outlook-to-pdf': OutlookToPDFPage,
  'web-page-to-pdf': WebPageToPDFPage,
...
export function PDFtoConvertPage({ onBack, searchQuery = "" }) {
    ...
    if (hashParts[0] === 'convert-to-pdf' && hashParts[1]) {
  ...
  React.useEffect(() => {
    if (selectedTool) {
      window.history.pushState({ toolOpen: true }, '', `#convert-to-pdf/${selectedTool.id}`);
      window.scrollTo(0, 0);
    }
  }, [selectedTool]);
