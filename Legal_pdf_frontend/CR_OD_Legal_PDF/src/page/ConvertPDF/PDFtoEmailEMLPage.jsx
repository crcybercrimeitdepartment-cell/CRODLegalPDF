...
export default function PDFtoEmailEMLPage({ onBack }) {
  const toolName = "PDF to Email EML";
  const toolDesc = "Convert your PDF with PDF to Email EML.";
  const apiSlug = "pdf-to-email";
  const outputExt = ".eml";
