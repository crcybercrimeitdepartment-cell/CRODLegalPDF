...
export default function PDFtoIllustratorAIPage({ onBack }) {
  const toolName = "PDF to Illustrator AI";
  const toolDesc = "Convert your PDF with PDF to Illustrator AI.";
  const apiSlug = "pdf-to-illustrator";
  const outputExt = ".zip";
