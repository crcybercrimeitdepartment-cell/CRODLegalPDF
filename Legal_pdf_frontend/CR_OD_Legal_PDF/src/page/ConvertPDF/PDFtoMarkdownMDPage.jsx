...
export default function PDFtoMarkdownMDPage({ onBack }) {
  const toolName = "PDF to Markdown";
  const toolDesc = "Convert your PDF with PDF to Markdown.";
  const apiSlug = "pdf-to-markdown";
  const outputExt = ".md";
