...
export default function PDFtoODPOpenDocumentPresentationPage({ onBack }) {
  const toolName = "PDF to ODP";
  const toolDesc = "Convert your PDF with PDF to ODP.";
  const apiSlug = "pdf-to-odp";
  const outputExt = ".odp";
