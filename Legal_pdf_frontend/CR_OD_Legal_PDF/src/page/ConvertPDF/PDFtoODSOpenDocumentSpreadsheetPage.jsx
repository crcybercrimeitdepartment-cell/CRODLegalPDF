...
export default function PDFtoODSOpenDocumentSpreadsheetPage({ onBack }) {
  const toolName = "PDF to ODS";
  const toolDesc = "Convert your PDF with PDF to ODS.";
  const apiSlug = "pdf-to-ods";
  const outputExt = ".ods";
