...
export default function PDFtoODTOpenDocumentTextPage({ onBack }) {
  const toolName = "PDF to ODT";
  const toolDesc = "Convert your PDF with PDF to ODT.";
  const apiSlug = "pdf-to-odt";
  const outputExt = ".odt";
