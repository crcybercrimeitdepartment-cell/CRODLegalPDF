...
export default function PDFtoOutlookMSGPage({ onBack }) {
  const toolName = "PDF to Outlook MSG";
  const toolDesc = "Convert your PDF with PDF to Outlook MSG.";
  const apiSlug = "pdf-to-outlook";
  const outputExt = ".msg";
