...
export default function PDFtoPhotoshopPSDPage({ onBack }) {
  const toolName = "PDF to Photoshop PSD";
  const toolDesc = "Convert your PDF with PDF to Photoshop PSD.";
  const apiSlug = "pdf-to-photoshop";
  const outputExt = ".zip";
