...
export default function PDFtoPowerPointPage({ onBack }) {
  const toolName = "PDF to PowerPoint";
  const toolDesc = "Convert your PDF with PDF to PowerPoint.";
  const apiSlug = "pdf-to-powerpoint";
  const outputExt = ".pptx";
