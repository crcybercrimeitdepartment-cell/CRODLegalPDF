...
export default function PDFtoPublisherPUBPage({ onBack }) {
  const toolName = "PDF to Publisher";
  const toolDesc = "Convert your PDF with PDF to Publisher.";
  const apiSlug = "pdf-to-publisher";
  const outputExt = ".pub";
