...
export default function PDFtoRAWImagePage({ onBack }) {
  const toolName = "PDF to RAW Image";
  const toolDesc = "Convert your PDF with PDF to RAW Image.";
  const apiSlug = "pdf-to-raw-image";
  const outputExt = ".zip";
