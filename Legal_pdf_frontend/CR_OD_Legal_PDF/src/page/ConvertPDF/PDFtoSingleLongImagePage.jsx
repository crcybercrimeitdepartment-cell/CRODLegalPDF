...
export default function PDFtoSingleLongImagePage({ onBack }) {
  const toolName = "PDF to Single Long Image";
  const toolDesc = "Convert your PDF with PDF to Single Long Image.";
  const apiSlug = "pdf-to-png";
  const outputExt = ".zip";
