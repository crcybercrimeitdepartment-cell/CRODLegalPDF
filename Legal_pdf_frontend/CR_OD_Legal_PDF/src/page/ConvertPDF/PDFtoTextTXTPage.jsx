...
export default function PDFtoTextTXTPage({ onBack }) {
  const toolName = "PDF to Text (TXT)";
  const toolDesc = "Convert your PDF with PDF to Text (TXT).";
  const apiSlug = "pdf-to-txt";
  const outputExt = ".txt";
