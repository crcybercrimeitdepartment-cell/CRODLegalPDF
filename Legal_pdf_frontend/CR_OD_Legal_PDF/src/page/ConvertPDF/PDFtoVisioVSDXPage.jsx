...
export default function PDFtoVisioVSDXPage({ onBack }) {
  const toolName = "PDF to Visio";
  const toolDesc = "Convert your PDF with PDF to Visio.";
  const apiSlug = "pdf-to-visio";
  const outputExt = ".vsdx";
