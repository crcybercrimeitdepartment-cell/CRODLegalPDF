              ...
              {isProcessing ? (
                ...
                <div className="animate-in fade-in zoom-in duration-300">
                  ...
                  {!xmpData.includes('<x:xmpmeta') && (
                    <div className="mt-6 text-center py-4 text-sm font-semibold text-amber-700 bg-amber-50 rounded-xl border border-amber-200">
                      No XMP Metadata found in this document.
                    </div>
                  )}
                </div>
              ) : null}
