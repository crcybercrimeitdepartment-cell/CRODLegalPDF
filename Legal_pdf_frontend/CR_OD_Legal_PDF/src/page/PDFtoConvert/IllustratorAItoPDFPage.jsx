...
export default function IllustratorAItoPDFPage({ onBack }) {
  const toolName = "Illustra to rAI to PDF";
  const toolDesc = "Convert ILLUSTRATORAI to PDF";
  const apiSlug = "illustrator-to-pdf";
