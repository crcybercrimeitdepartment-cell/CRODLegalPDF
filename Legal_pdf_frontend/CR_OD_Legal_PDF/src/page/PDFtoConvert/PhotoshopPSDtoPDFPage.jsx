...
export default function PhotoshopPSDtoPDFPage({ onBack }) {
  const toolName = "Pho to shopPSD to PDF";
  const toolDesc = "Convert PHOTOSHOPPSD to PDF";
  const apiSlug = "photoshoppsd-to-pdf";
