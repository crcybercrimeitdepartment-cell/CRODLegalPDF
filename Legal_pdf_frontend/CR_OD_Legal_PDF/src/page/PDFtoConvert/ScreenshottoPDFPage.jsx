...
export default function ScreenshottoPDFPage({ onBack }) {
  const toolName = "Screenshot to PDF";
  const toolDesc = "Convert SCREENSHOT to PDF";
  const apiSlug = "screenshot-to-pdf";
